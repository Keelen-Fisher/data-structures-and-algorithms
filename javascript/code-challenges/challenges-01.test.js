...
const allUpperCase = (arr) => {
  let newArrayCap = [];
  arr.forEach(function(value, index){
    newArrayCap.push(value.toUpperCase());
  });
  return newArrayCap;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(string =>{
    newArrayCapStr.push(callback(string));
  });
  return newArrayCapStr;
};
